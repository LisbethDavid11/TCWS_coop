...
public class cooperativistas_tabla extends JFrame {

    public TableRowSorter<TableModel> trsfiltroCodigo;
    String filtroCodigo;
    empleados clase_empleado = new empleados();
                ...
                if (e.getClickCount() == 2) { // Doble clic
                    ...
                    if (filaSeleccionada != -1) { // Validar que hay una fila seleccionada
                        ...
                        try {
                            ...
                            // Enviar datos a cooperativistas_nuevo
                            cooperativistas_nuevo ventanaNuevo = new cooperativistas_nuevo();
                            ...
                            // Configurar botones en cooperativistas_nuevo
    ...
    public static ArrayList<empleados> buscarUsuariosConMatriz() {
        ...
        ArrayList<empleados> miLista = new ArrayList<>();
        try {
