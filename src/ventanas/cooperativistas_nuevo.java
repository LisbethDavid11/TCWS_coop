...
public class cooperativistas_nuevo extends JFrame{
	...
	public consultas_empleados consultas;
	...
	public cooperativistas_nuevo() {
		...
		btnseleccionar_foto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					seleccionador.setDialogTitle("Buscar fotografia del empleados...");
					...
					if (seleccion == JFileChooser.APPROVE_OPTION) {
						...
						try {
							...
							Logger.getLogger(cooperativistas_nuevo.class.getName()).log(Level.SEVERE, null, ex);
						}
		...
		public boolean validarCamposEmpleadoGuardar() {
		    ...
		    if (!buttonfemenino.isSelected() && !buttonmasculino.isSelected() && !buttonotro.isSelected()) {
		        JOptionPane.showMessageDialog(null, "Debe seleccionar un sexo para el empleados", "Advertencia", JOptionPane.WARNING_MESSAGE);
		        return false;
		    }
		...
		public void actualizarEmpleado() {
		    try {
		        ...
		        // Lógica para actualizar el empleados en la base de datos
